...
(function($) {
	...
	var defaults = {
		...
		animateNumberOver: 		{backgroundColor:'#0077c1', color:'#000'},

		animateNumberActive: 	{backgroundColor:'#dc1e1e', color:'#fff'},
		...
		mouseOutButton: 		function() { $(this).stop().animate({opacity:0.8}, 500); },
